...
# endif
	...
	struct drm_check a[] = {
		...
		//{ ARG_STR(DRM_IOCTL_SET_UNIQUE) }, invalid_op
		...
		//{ ARG_STR(DRM_IOCTL_MOD_CTX), ctx, print_drm_mod_ctx },
		...
		//{ ARG_STR(DRM_IOCTL_ADD_DRAW), draw, print_drm_add_draw },
		//{ ARG_STR(DRM_IOCTL_RM_DRAW), draw, print_drm_rm_draw },
		//{ ARG_STR(DRM_IOCTL_DMA) }, TODO
		{ ARG_STR(DRM_IOCTL_LOCK), lock, print_drm_lock },
		{ ARG_STR(DRM_IOCTL_UNLOCK), lock, print_drm_lock },
		//{ ARG_STR(DRM_IOCTL_FINISH), lock, print_drm_finish },
...
# endif
		//{ ARG_STR(DRM_IOCTL_UPDATE_DRAW) }, noop
		...
		//{ ARG_STR(DRM_IOCTL_MODE_ATTACHMODE), mode_cmd, print_drm_mode_attachmode },
		//{ ARG_STR(DRM_IOCTL_MODE_DETACHMODE), mode_cmd, print_drm_mode_detachmode },
